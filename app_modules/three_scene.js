...
function initializeScene(){
    ...
    var cubeMap = loader.load([
        'rtoole13.github.io/OrbitalElements/assets/textures/sky_posx.png',
        'rtoole13.github.io/OrbitalElements/assets/textures/sky_negx.png',
        'rtoole13.github.io/OrbitalElements/assets/textures/sky_posz.png',
        'rtoole13.github.io/OrbitalElements/assets/textures/sky_negz.png',
        'rtoole13.github.io/OrbitalElements/assets/textures/sky_posy.png',
        'rtoole13.github.io/OrbitalElements/assets/textures/sky_negy.png',
    ]);
    ...
    var alphaMap = new THREE.TextureLoader().load('rtoole13.github.io/OrbitalElements/assets/textures/plane_alpha.png' );
    // alphaMap.wrapS = THREE.RepeatWrapping;
    // alphaMap.wrapT = THREE.RepeatWrapping;
    // alphaMap.repeat.set(2, 2);
    var texture = new THREE.TextureLoader().load('rtoole13.github.io/OrbitalElements/assets/textures/checkerboard-pattern.jpg');
